...
import { FrameAndButton } from "../components/FrameAndButton";
...
export class Home extends Component {
  ...
  callback = response => {
    ...
    let urlToDisplay =
      "https://mernurl.herokuapp.com/" + response.data.short_url;

    //handle bad urls
    if (response.data.short_url == undefined) {
      //show error message
      urlToDisplay =
        "Invalid URL. Please check again. Make sure to include http:// or https://";
  ...
  render() {
    return (
      <div className="page">
        ...
        <Ending linksPowered={this.state.linksPowered} />
